...
| Vert | `#012418` | grandes sections de marque (vue éclatée, « il tuo corpo merita ») |
| Vert vif | `#1E9E5A` | coches de validation, indicateurs positifs |
| Or | `#BCA588` | filets décoratifs, traits de séparation dans les sections vertes |
| Beige | `#BCA588` | titres des sections vertes |
